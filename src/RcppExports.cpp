...
RcppExport SEXP _RCudaBlas_matrix_multiplication_cuda(SEXP mat1SEXP, SEXP mat2SEXP) {
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(matrix_multiplication_cuda(mat1, mat2));
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< NumericMatrix >::type mat1(mat1SEXP);
    Rcpp::traits::input_parameter< NumericMatrix >::type mat2(mat2SEXP);
    rcpp_result_gen = Rcpp::wrap(matrix_multiplication_cuBLAs(mat1, mat2));
    return rcpp_result_gen;
END_RCPP
}
...
RcppExport void R_init_RCudaBlas(DllInfo *dll) {
